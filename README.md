...
3. Unknown and not known; will support be available?; smallest and lightest; tried to convert array data into csv (necessary input, but after some time just gave up, not a lib for my use-case)
